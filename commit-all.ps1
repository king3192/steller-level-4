# PowerShell script to execute atomic, conventional commits for Level 4 production upgrade and push to GitHub

$ErrorActionPreference = "Continue"

Write-Host "Executing Level 4 Production Upgrade Commit Sequence..." -ForegroundColor Cyan
...
Write-Host "`nSetting remote origin to https://github.com/king3192/steller-level-4.git..." -ForegroundColor Yellow
$remotes = git remote
if ($remotes -contains "origin") {
    git remote set-url origin https://github.com/king3192/steller-level-4.git
} else {
    git remote add origin https://github.com/king3192/steller-level-4.git
}
...
Write-Host "`nAll commits created and pushed to https://github.com/king3192/steller-level-4.git successfully!" -ForegroundColor Green
